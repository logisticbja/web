...
export default async function BlogPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      {/* Header hero — statis, halaman ini daftar semua artikel, bukan 1 artikel */}
      <div className="bg-gradient-to-br from-[#CC1F2A] to-[#8B1219] py-14 px-4">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        {posts.length === 0 ? (
          ...
          <>
            ...
            {featured && (
              <div className="mb-10">
                <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-5">Artikel Utama</h2>
