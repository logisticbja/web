...
import { MessageCircle, Clock, Ship, Zap, CheckCircle, ArrowRight, MapPin, Package } from "lucide-react";
    ...
    <>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
            ...
            <div className="sm:shrink-0 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-5 sm:w-52">
              ...
              <p className="text-white/40 text-xs mt-3">*Estimasi. Min. 100 kg. Konfirmasi via WA.</p>
            </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12 space-y-14">
        ...
        <div>
          ...
          <div className="bg-[#F8FAFC] rounded-3xl p-8 grid grid-cols-3 sm:grid-cols-5 gap-6 items-center">
            {corporateClients.map((client) => (
              <div key={client.alt} className="flex items-center justify-center grayscale opacity-70 hover:opacity-100 hover:grayscale-0 transition-all">
                <Image src={client.src} alt={client.alt} width={120} height={60} className="object-contain w-full h-auto" />
              </div>
            ))}
          </div>
