    ...
    <section className="py-20 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <p className="text-[#F97316] font-bold text-sm uppercase tracking-wider mb-2">Layanan Kami</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className="w-14 h-14 rounded-xl bg-[#1B3A6B]/10 flex items-center justify-center mb-4 group-hover:bg-[#1B3A6B] transition-colors">
                  <Icon size={26} className="text-[#1B3A6B] group-hover:text-white transition-colors" />
                </div>

                {/* Content */}
                <h3 className="text-lg font-black text-[#0F172A] mb-2">{service.name}</h3>
                ...
                <div className="flex items-center justify-between py-3 border-t border-gray-100 mb-4">
                  <div>
                    ...
                    <p className="font-black text-[#1B3A6B]">{service.priceFrom}</p>
                  </div>
                ...
                <div className="flex gap-2">
                  ...
                  <Link
                    href={service.href}
                    className="flex items-center gap-1 px-3 py-2 rounded-lg border border-gray-200 text-xs font-semibold text-gray-600 hover:border-[#1B3A6B] hover:text-[#1B3A6B] transition-colors"
                  >
